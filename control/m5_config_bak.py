...
links = [ 
          ...
          Link(8, fifty, "enp3s0f0", [pops[1], pops[4]], ["10.0.6.1", "10.0.6.2"]),
          Link(9, 50, "enp1s0f0", [pops[4], pops[1]], ["10.0.6.2", "10.0.6.1"]),

          Link(10, 50, "enp1s0f0", [pops[2], pops[0]], ["10.0.2.1", "10.0.2.2"]),
          Link(11, fifty, "enp3s0f0", [pops[0], pops[2]], ["10.0.2.2", "10.0.2.1"]),

          Link(12, fifty, "enp1s0f0", [pops[0], pops[1]], ["10.0.0.1", "10.0.0.2"]),
