...
pops = [ Pop(0, "jc3377",   "51.143.101.5", "10.0.0.4", "jc3377"), 
         Pop(1, "jc3377",   "104.42.62.47", "10.0.1.4", "jc3377"),
         Pop(2, "jc3377",   "168.62.109.115", "10.0.2.4", "jc3377"),
         Pop(3, "jc3377",   "70.37.160.81",  "10.0.3.4", "jc3377"),
         Pop(4, "jc3377",   "40.71.169.74", "10.0.4.4", "jc3377") ]

two_h = 190

links = [ 
          Link(0, two_h, "eth0", [pops[0], pops[1]], ["10.0.0.4", "10.0.1.4"]), # mark
          Link(1, 200, "eth0", [pops[1], pops[0]], ["10.0.1.4", "10.0.0.4"]),

          Link(2, two_h, "eth1", [pops[0], pops[2]], ["10.0.0.5", "10.0.2.4"]), # mark
          Link(3, 200, "eth0", [pops[2], pops[0]], ["10.0.2.4", "10.0.0.5"]),
