    ...
    case $cmd in
        start)
            ...
            ssh jiangnan@10.0.2.1 "
                cd Desktop/MPP
                nohup ./bin/mpp_adv_egress 3 1 10.0.1.1 50020 10.0.2.1 50020 10.0.3.1 50020 127.0.0.1 50050 10.0.2.1 51000 > /dev/null 2>&1 &
            "
            ssh jc3377@10.0.0.2 "
                cd Desktop/MPP
                nohup ./bin/mpp_adv_ingress 1 2 127.0.0.1 50000 10.0.0.1 50020 10.0.1.1 50020 10.0.0.2 51000 > /dev/null 2>&1 &
            "
